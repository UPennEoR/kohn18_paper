...
the Galactic Center and much of the Galactic Plane, the average sky temperature was 2000 K \citep[][also see the public \href{http://reionization.org/wp-content/uploads/2017/04/HERA19_Tsys_3April2017.pdf}{\edited{\underline{HERA Memo \#16}}}]{deBoer17}.
...
$k_{\parallel}>XXX$ h/Mpc (dot-dashed lines), corresponding to the approximately white level in Figure~\ref{}.  To match the observed level in Stokes I high band, as shown in required an assumed system temperature of XXX K.  The implied system temperature is somewhat higher than that expected based on the sky and beam model from the simulations, or from the measured calibrated autocorrelations.  
